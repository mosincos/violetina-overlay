...
HOMEPAGE="http://wiki.faust-lv2.googlecode.com"

# Point to any required sources; these will be automatically downloaded by
# Portage.
SRC_URI="http://faust-lv2.googlecode.com/files/${P}.tar.bz2"

#http://faust-lv2.googlecode.com/files/faust-lv2-0.3.tar.bz2
...
src_configure() {
./waf configure  --lv2dir="${D}usr/lib/lv2" --split-bundles --prefix=/usr  --no-faust-install
#	./waf configure --prefix=/usr
# waf-utils_src_configure --lv2dir="${D}usr/lib/lv2" --split-bundles --prefix=/usr  --no-faust-install 
#       ./waf configure --prefix=/usr
}
